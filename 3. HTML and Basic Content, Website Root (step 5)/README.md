...
- Create a sitemap and organised file/folder structure.
- Create a minimum of five HTML pages.
- Use appropriate HTML structure, content, images and links.
- Provide navigation between the HTML pages.
- Test and debug the HTML pages.
...
- the HTML displays correctly;
- there are no broken internal links;
- the pages are readable and usable.
